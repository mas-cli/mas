...
complete -c mas -n "__fish_seen_subcommand_from help" -xa 'config get help home install list lookup lucky open outdated reset search seller signout uninstall update version'
